...
class YOLOv1Net(object):
    ...
    def build_network(self, num_outputs, alpha, keep_prob=0.5, training=True):
        ...
        # 1
        # model.add(keras.layers.Lambda(lambda x: tf.pad(x, np.array([[0, 0], [3, 3], [3, 3], [0, 0]]), name="pad0"),name="pad0"))
        # input_shape=(self.image_size, self.image_size, 3),
        model.add(keras.layers.Conv2D(filters=64, kernel_size=7, strides=(2, 2), padding="same", input_shape=(self.image_size, self.image_size, 3), name="conv1"))
        ...
        # 2
        model.add(keras.layers.Conv2D(filters=192, kernel_size=7, strides=(1, 1), padding="same", name="conv2"))
        ...
        # 3
        model.add(keras.layers.Conv2D(filters=128, kernel_size=1, strides=(1, 1), padding="same", name="conv3"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu3"))
        model.add(keras.layers.Conv2D(filters=256, kernel_size=3, strides=(1, 1), padding="same", name="conv4"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu4"))
        model.add(keras.layers.Conv2D(filters=256, kernel_size=1, strides=(1, 1), padding="same", name="conv5"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu5"))
        model.add(keras.layers.Conv2D(filters=512, kernel_size=3, strides=(1, 1), padding="same", name="conv6"))
        ...
        # 4
        model.add(keras.layers.Conv2D(filters=256, kernel_size=1, strides=(1, 1), padding="same", name="conv7"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu7"))
        model.add(keras.layers.Conv2D(filters=512, kernel_size=3, strides=(1, 1), padding="same", name="conv8"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu8"))
        model.add(keras.layers.Conv2D(filters=256, kernel_size=1, strides=(1, 1), padding="same", name="conv9"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu9"))
        model.add(keras.layers.Conv2D(filters=512, kernel_size=3, strides=(1, 1), padding="same", name="conv10"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu10"))
        model.add(keras.layers.Conv2D(filters=256, kernel_size=1, strides=(1, 1), padding="same", name="conv11"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu11"))
        model.add(keras.layers.Conv2D(filters=512, kernel_size=3, strides=(1, 1), padding="same", name="conv12"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu12"))
        model.add(keras.layers.Conv2D(filters=256, kernel_size=1, strides=(1, 1), padding="same", name="conv13"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu13"))
        model.add(keras.layers.Conv2D(filters=512, kernel_size=3, strides=(1, 1), padding="same", name="conv14"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu14"))
        model.add(keras.layers.Conv2D(filters=512, kernel_size=1, strides=(1, 1), padding="same", name="conv15"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu15"))
        model.add(keras.layers.Conv2D(filters=1024, kernel_size=3, strides=(1, 1), padding="same", name="conv16"))
        ...
        # 5
        model.add(keras.layers.Conv2D(filters=512, kernel_size=1, strides=(1, 1), padding="same", name="conv17"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu17"))
        model.add(keras.layers.Conv2D(filters=1024, kernel_size=3, strides=(1, 1), padding="same", name="conv18"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu18"))
        model.add(keras.layers.Conv2D(filters=512, kernel_size=1, strides=(1, 1), padding="same", name="conv19"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu19"))
        model.add(keras.layers.Conv2D(filters=1024, kernel_size=3, strides=(1, 1), padding="same", name="conv20"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu20"))
        model.add(keras.layers.Conv2D(filters=1024, kernel_size=3, strides=(1, 1), padding="same", name="conv21"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu21"))
        # 有一个pad补全？？？？
        # model.add(keras.layers.Lambda(lambda x: tf.pad(x, np.array([[0, 0], [1, 1], [1, 1], [0, 0]]), name="pad1"), name="pad1"))
        model.add(keras.layers.Conv2D(filters=1024, kernel_size=3, strides=(2, 2), padding="same", name="conv22"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu22"))
        # 6
        model.add(keras.layers.Conv2D(filters=1024, kernel_size=3, strides=(1, 1), padding="same", name="conv23"))
        model.add(keras.layers.LeakyReLU(alpha=alpha, name="leaky_relu23"))
        model.add(keras.layers.Conv2D(filters=1024, kernel_size=3, strides=(1, 1), padding="same", name="conv24"))
